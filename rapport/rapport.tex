...
\begin{description}
\item[Concurrence:] pour être précis cela a été implémenté sur une branche mais pas avec assez de succès pour être rendu % peut être déplacer dans extentions ?
\item[Très très gros messages:] taille des messages sur 4 octets
