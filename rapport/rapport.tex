...
\begin{abstract}
  ...
  Plusieurs extentions ont été développées parmis lesquelles \textbf{la fragmentation de gros messages(\ref{sec:frag}), l'agrégation de tlv, quelques optimisations de l'inondation et l'implémentation d'une interface web(\ref{sec:web})}.
\end{abstract}
